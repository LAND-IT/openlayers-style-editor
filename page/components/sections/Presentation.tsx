    ...
    return (
        <div>
            ...
            <ul>
                ...
                <li><b>Quantitative:</b> Allows the user to change the layer&apos;s color, opacity, and stroke based on a
                ...
                <li><b>Based on Rules:</b> Allows the user to change the layer's color, opacity, and stroke based on rules defined by the user.
                    Each rule is composed by a name, a filter, and a renderer. The filter is a logical expression that defines which features will be styled with the renderer of the rule.</li>
